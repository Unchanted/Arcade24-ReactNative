  ...
  return (
    <div className="relative min-h-screen bg-cover bg-center" style={{ backgroundImage: 'url(/path-to-your-image.jpg)' }}>
      <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent">
        <div className="flex flex-col items-center justify-end min-h-screen pb-10 space-y-4">
          <Link to="/signup">
            <button
          ...
          <Link to="/login">
            <button
              className="border border-white text-white font-bold py-2 px-4 rounded-full bg-transparent"
              style={{ borderRadius: '81px' }}
            >
              Log In
            </button>
